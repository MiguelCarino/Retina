...
const I18N = {
    es:{
      ...
      'Calibrate on chart screen':'Calibrar en la pantalla de test','Done — back to the test':'Listo — volver al test',
      'Open a chart on the screen you want to calibrate first':'Abre primero un optotipo en la pantalla que quieres calibrar',
      'chart screen':'pantalla de test','chart not in sync':'el optotipo no está sincronizado','chart window zoom is not 1.00':'el zoom de la ventana del optotipo no es 1,00',
    ...
    ja:{
      ...
      'Open a chart on the screen you want to calibrate first':'先にキャリブレーションしたい画面で視標を開いてください',
